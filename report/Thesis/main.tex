...
Con una immagine $511\times 95$ il metodo findContours impiega in media circa \verb|0.0024s|**[NOTA: sulla mia macchina,  attendo test su server azienda per aggiornare valore e inserire specifiche macchina] %TODO specifiche macchina
...
\bibitem{texbook}
scikit-image code 
URL: \url{https://github.com/scikit-image/scikit-image/tree/main/skimage/measure}

\bibitem{lamport94}
Nvidia nvc++ -stdpar and Cython
URL: \url{https://developer.nvidia.com/blog/accelerating-python-on-gpus-with-nvc-and-cython/)}
